...
import time
from transformers import get_linear_schedule_with_warmup, DebertaV2Tokenizer, DebertaV2Model, DebertaV2PreTrainedModel, DebertaV2Config
...
class FeedbackModel(DebertaV2PreTrainedModel):
    ...
    def forward(self, ids, mask, token_type_ids):
        # pooler
        emb = self.deberta(ids, attention_mask=mask, token_type_ids=token_type_ids)["last_hidden_state"]
